...
public :
   ...
   TimeToolForRun(TTree *tree=0);
   virtual ~TimeToolForRun();
...
#ifdef TimeToolForRun_cxx
TimeToolForRun::TimeToolForRun(TTree *tree) //: fChain(0)
{
...
TimeToolForRun::~TimeToolForRun()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TimeToolForRun::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TimeToolForRun::LoadTree(Long64_t entry)
{
...
void TimeToolForRun::Show(Long64_t entry)
{
...
Int_t TimeToolForRun::Cut(Long64_t entry)
{
...
#endif // #ifdef TimeToolForRun_cxx
